...
/**
 * Script to update bluefin-driver-versions.md with latest release information
...
const DOC_PATH = path.join(__dirname, '../docs/reports/ublue/bluefin-driver-versions.md');
